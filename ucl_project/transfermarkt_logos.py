...
LOGO_URL = "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/{team_id}.png"


class TransfermarktLogoManager:
    ...
    def _ensure_logo_cached(self, team_id: int) -> Path:
        ...
        response = requests_lib.get(LOGO_URL.format(team_id=team_id), timeout=15)
